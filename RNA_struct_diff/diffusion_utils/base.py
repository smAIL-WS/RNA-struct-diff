...
class BaseExperiment(object):
    ...
    def create_folders(self):
        """
        Create log and checkpoint directories in a DDP-safe way.
        Only the main process creates the directories to avoid race conditions.
        """
        ...
        if is_main_process():
            ...
            # Create checkpoint folder (only if needed)
...
class DDPDistribution(DDP):
    def log_prob(self, *args, **kwargs):
        return self.module.forward(*args, mode='log_prob', **kwargs)
